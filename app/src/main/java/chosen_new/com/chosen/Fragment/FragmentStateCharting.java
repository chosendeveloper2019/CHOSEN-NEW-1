...
public class FragmentStateCharting extends Fragment implements View.OnClickListener {
    ...
    private TextView tv_pole_id,tv_start_charge,tv_end_charge,tv_state_charge,tv_state,tv_hr,tv_min,tv_kwh,tv_card_id;
...
//    private LinearLayout state;n
    ...
    private void initInstance(View v) {
        ...
        tv_pole_id = v.findViewById(R.id.tv_pole_id);
