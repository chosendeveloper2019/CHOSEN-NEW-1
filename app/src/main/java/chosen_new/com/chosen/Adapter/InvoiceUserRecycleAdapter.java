...
public class InvoiceUserRecycleAdapter extends RecyclerView.Adapter<InvoiceUserRecycleAdapter.MyHolder> {
...
private  ProgressDialog  progressDialog;
    ...
    public InvoiceUserRecycleAdapter(Context context){
    ...
    @Override
    public InvoiceUserRecycleAdapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_view_invoice_card,parent,false);
            return new InvoiceUserRecycleAdapter.MyHolder(v,context);
            }
...
//            });
            ...
            holder.btn_view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    showDetailinvoice(val.get(position).get(MyFerUtil.KEY_PAY_CODE).toString(),
            ...
            holder.setOnClickRecycleView(new RecycleViewOnClickListener() {
                ...
                public void onClick(View view, int position, boolean isLongClick, MotionEvent motionEvent) {
                    ...
                    //        Toast.makeText(context, ""+val.get(position).get(MyFerUtil.KEY_PAY_CODE).toString(), Toast.LENGTH_SHORT).show();
                    //        FragmentPaypalWebview  webviewFrg = new FragmentPaypalWebview();
                    //        fragmentTran(webviewFrg,null);
...
//        TextView tv_card_id,tv_date_start,tv_date_end,tv_price;
        Button btn_view,btn_pay;
    ...
    private void showDetailinvoice(String payCode,String create_date,String price,String card_id,String poleid){
        ...
        tv_header_detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                alertDialog.dismiss();
            }
...
//            Log.e(TAG,""+result);
    ...
    CallbackInvoiceListener listenerInvoiceSend = new CallbackInvoiceListener() {
        ...
        public void onResponse(ResultPaymentModel res) {
           ...
           //goto web view
            fragmentTran(new FragmentPaypalWebview(),null);
